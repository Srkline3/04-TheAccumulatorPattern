...
#
#              for k in range(r - s):        the range should be s-r+1 so it is inclusive
#                  count = 0                 this should not be inside the loop
#                  if math.cos(r) > 0:
#                      count = 1              this will just return 1, should be count = count + 1
#                  return count               indented to far over
#
